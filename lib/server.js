( function(){
	...
	module.exports = function( options ){
        ...
        function _isValidUpload( upload ){
            if( !upload.key ) return new Error( "settings.key is required" );
            if( !upload.filename ) return new Error( "settings.filename is required" );
            if( !upload.completeUrl ) return new Error( "settings.completeUrl is required" );

            if( !upload.filesize ) return new Error( "settings.filesize is required" );
            ...
            if( !upload.filetype ) return new Error( "settings.filetype is required" );
