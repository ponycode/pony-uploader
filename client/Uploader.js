...
class Uploader {
	...
	uploadToS3( uploadUrl, uploadData, progressCallback, callback ){
	...
	_getSignedUpload( signatureUrl, fileData, callback ){
		var req = {
	...
	_completeUpload( completeUrl, callback ){
		var req = {
			url: completeUrl
		};
